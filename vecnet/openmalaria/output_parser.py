...
surveyFileMap = \
    [
        ...
        ("nTreatments1", "age group", "number of treatments (1st line)"),
        ("nTreatments2", "age group", "number of treatments (2nd line)"),
        ("nTreatments3", "age group", "number of treatments (inpatient)"),
        ...
        ("inputEIR", "(unused)",
         ...
         "Units: average inoculations per adult over the time period since the last survey "
        ...
        ("simulatedEIR", "(unused)",
         ...
         "by adults. Units: average inoculations per adult over the time period since the last survey."
         "measured in infectious bites per person per time step."),
        None,
        None,
